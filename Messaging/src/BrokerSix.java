...
class BrokerSix
{
	...
	public static void main(String[] args)
	{
		try 
		{
			...
			System.out.println("***************::BrokerSix (B6)::***************");
			...
			InMsgHandler4B6 inMsgThread = new InMsgHandler4B6("B4");
			inMsgThread.start( );
			//this thread handle outgoing msg to neighbor by output message queue
			OutputQueueHandler4B6 outQueueThread = new OutputQueueHandler4B6();
			outQueueThread.start();
			//this thread handle the input message queue
			InputQueueHandler4B6 inQueueThread = new InputQueueHandler4B6();
			inQueueThread.start();
			//this thread handle the input data entered into the console
			DataEntryHandler4B6 dataEntryThread = new DataEntryHandler4B6();
