...
class BrokerFive
{
	...
	public static void main(String[] args)
	{
		try 
		{
			...
			System.out.println("***************::BrokerFive (B5)::***************");
			...
			neighbors.put("B4", new Neighbors(clientSocket, is, os));
			//this thread handle incoming msg from neighbor
			InMsgHandler4B5 inMsgThread = new InMsgHandler4B5("B4");
			inMsgThread.start( );
			//this thread handle outgoing msg to neighbor by output message queue
			OutputQueueHandler4B5 outQueueThread = new OutputQueueHandler4B5();
			outQueueThread.start();
			//this thread handle the input message queue
			InputQueueHandler4B5 inQueueThread = new InputQueueHandler4B5();
			inQueueThread.start();
			//this thread handle the input data entered into the console
			DataEntryHandler4B5 dataEntryThread = new DataEntryHandler4B5();
